...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        def _reuse_live_response(sid: str, session: dict) -> dict:
            # Slow-path claim races can return a winner after releasing their own
            # lock. Keep the client-gone check and transport rebind atomic with
            # grace expiry. Call the locked variant from sections that already
            # hold this non-reentrant lock.
