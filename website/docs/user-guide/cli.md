...
Interactive CLI sessions can attach to the same canonical runtime as the TUI,
Desktop, dashboard, and authorized messaging clients. One-shot `-q` remains a
bounded producer. See [Multi-Client Live Sessions](features/multi-client-live-sessions.md).
